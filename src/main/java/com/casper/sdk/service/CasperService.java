...
public interface CasperService {
     ...
     *
     * @param host   the peer hostname or IP to connect to
     ...
     */
    static CasperService usingPeer(final String host, final int port) throws MalformedURLException {
